...
const Contrast = ({}: ContrastProps) => {
  ...
  return (
    <div className="bg-black/5 dark:bg-white/10 p-4 rounded-lg backdrop-blur pointer-events-auto flex flex-col gap-4">
      ...
      />
      <UiSwitch
        enabled={darkenWarning}
        setEnabled={setDarkenWarning}
